...
return cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.max,(0),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__20985_SHARP_){
return expound.printer.str_width(clojure.string.split_lines(cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.nth.cljs$core$IFn$_invoke$arity$2(p1__20985_SHARP_,i))));
}),rows));
});
expound.printer.max_row_height = (function expound$printer$max_row_height(row){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.max,(0),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__20992_SHARP_){
return cljs.core.count(clojure.string.split_lines(cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__20992_SHARP_)));
}),row));
});
...
var G__21034 = ["%-",cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.nth.cljs$core$IFn$_invoke$arity$2(column_widths,i)),"s"].join('');
var G__21035 = v;
return (expound.printer.format.cljs$core$IFn$_invoke$arity$2 ? expound.printer.format.cljs$core$IFn$_invoke$arity$2(G__21034,G__21035) : expound.printer.format.call(null, G__21034,G__21035));
}),row);
}),multi_row);
}),multi_rows);
});
...
var columns_dividers = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__21051_SHARP_){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.str,cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(((cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__21051_SHARP_)).length),"-"));
}),header);
var header_columns_dividers = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__21052_SHARP_){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.str,cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(((cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__21052_SHARP_)).length),"="));
}),header);
...
var iter__5480__auto__ = (function expound$printer$multirow_$_iter__21074(s__21075){
return (new cljs.core.LazySeq(null,(function (){
var s__21075__$1 = s__21075;
while(true){
var temp__5804__auto__ = cljs.core.seq(s__21075__$1);
if(temp__5804__auto__){
var s__21075__$2 = temp__5804__auto__;
if(cljs.core.chunked_seq_QMARK_(s__21075__$2)){
var c__5478__auto__ = cljs.core.chunk_first(s__21075__$2);
var size__5479__auto__ = cljs.core.count(c__5478__auto__);
var b__21077 = cljs.core.chunk_buffer(size__5479__auto__);
if((function (){var i__21076 = (0);
while(true){
if((i__21076 < size__5479__auto__)){
var row_idx = cljs.core._nth(c__5478__auto__,i__21076);
cljs.core.chunk_append(b__21077,(function (){var iter__5480__auto__ = ((function (i__21076,row_idx,c__5478__auto__,size__5479__auto__,b__21077,s__21075__$2,temp__5804__auto__,split_row_contents){
return (function expound$printer$multirow_$_iter__21074_$_iter__21084(s__21085){
return (new cljs.core.LazySeq(null,((function (i__21076,row_idx,c__5478__auto__,size__5479__auto__,b__21077,s__21075__$2,temp__5804__auto__,split_row_contents){
return (function (){
var s__21085__$1 = s__21085;
while(true){
var temp__5804__auto____$1 = cljs.core.seq(s__21085__$1);
if(temp__5804__auto____$1){
var s__21085__$2 = temp__5804__auto____$1;
if(cljs.core.chunked_seq_QMARK_(s__21085__$2)){
var c__5478__auto____$1 = cljs.core.chunk_first(s__21085__$2);
var size__5479__auto____$1 = cljs.core.count(c__5478__auto____$1);
var b__21087 = cljs.core.chunk_buffer(size__5479__auto____$1);
if((function (){var i__21086 = (0);
while(true){
if((i__21086 < size__5479__auto____$1)){
var col_idx = cljs.core._nth(c__5478__auto____$1,i__21086);
cljs.core.chunk_append(b__21087,cljs.core.get_in.cljs$core$IFn$_invoke$arity$3(split_row_contents,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [col_idx,row_idx], null),""));

var G__21431 = (i__21086 + (1));
i__21086 = G__21431;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__21087),expound$printer$multirow_$_iter__21074_$_iter__21084(cljs.core.chunk_rest(s__21085__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__21087),null);
}
} else {
var col_idx = cljs.core.first(s__21085__$2);
return cljs.core.cons(cljs.core.get_in.cljs$core$IFn$_invoke$arity$3(split_row_contents,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [col_idx,row_idx], null),""),expound$printer$multirow_$_iter__21074_$_iter__21084(cljs.core.rest(s__21085__$2)));
}
} else {
return null;
}
...
});})(i__21076,row_idx,c__5478__auto__,size__5479__auto__,b__21077,s__21075__$2,temp__5804__auto__,split_row_contents))
,null,null));
});})(i__21076,row_idx,c__5478__auto__,size__5479__auto__,b__21077,s__21075__$2,temp__5804__auto__,split_row_contents))
;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__21077),expound$printer$multirow_$_iter__21074(cljs.core.chunk_rest(s__21075__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__21077),null);
}
} else {
var row_idx = cljs.core.first(s__21075__$2);
return cljs.core.cons((function (){var iter__5480__auto__ = ((function (row_idx,s__21075__$2,temp__5804__auto__,split_row_contents){
return (function expound$printer$multirow_$_iter__21074_$_iter__21112(s__21113){
return (new cljs.core.LazySeq(null,(function (){
var s__21113__$1 = s__21113;
while(true){
var temp__5804__auto____$1 = cljs.core.seq(s__21113__$1);
if(temp__5804__auto____$1){
var s__21113__$2 = temp__5804__auto____$1;
if(cljs.core.chunked_seq_QMARK_(s__21113__$2)){
var c__5478__auto__ = cljs.core.chunk_first(s__21113__$2);
var size__5479__auto__ = cljs.core.count(c__5478__auto__);
var b__21115 = cljs.core.chunk_buffer(size__5479__auto__);
if((function (){var i__21114 = (0);
while(true){
if((i__21114 < size__5479__auto__)){
var col_idx = cljs.core._nth(c__5478__auto__,i__21114);
cljs.core.chunk_append(b__21115,cljs.core.get_in.cljs$core$IFn$_invoke$arity$3(split_row_contents,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [col_idx,row_idx], null),""));

var G__21435 = (i__21114 + (1));
i__21114 = G__21435;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__21115),expound$printer$multirow_$_iter__21074_$_iter__21112(cljs.core.chunk_rest(s__21113__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__21115),null);
}
} else {
var col_idx = cljs.core.first(s__21113__$2);
return cljs.core.cons(cljs.core.get_in.cljs$core$IFn$_invoke$arity$3(split_row_contents,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [col_idx,row_idx], null),""),expound$printer$multirow_$_iter__21074_$_iter__21112(cljs.core.rest(s__21113__$2)));
}
} else {
return null;
}
...
});})(row_idx,s__21075__$2,temp__5804__auto__,split_row_contents))
;
return iter__5480__auto__(cljs.core.range.cljs$core$IFn$_invoke$arity$1(cljs.core.count(row)));
})(),expound$printer$multirow_$_iter__21074(cljs.core.rest(s__21075__$2)));
}
} else {
return null;
}
...
var rows = cljs.core.into.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [column_keys], null),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__21121_SHARP_){
return cljs.core.map.cljs$core$IFn$_invoke$arity$2(p1__21121_SHARP_,column_keys);
}),map_rows));
...
var form = (function (){var G__21152 = via;
var G__21152__$1 = (((G__21152 == null))?null:cljs.core.last(G__21152));
if((G__21152__$1 == null)){
return null;
} else {
return cljs.spec.alpha.form(G__21152__$1);
}
})();
var keys_specs = cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__21150_SHARP_){
return cljs.spec.alpha.valid_QMARK_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("expound.spec","keys-spec","expound.spec/keys-spec",-1760201532),p1__21150_SHARP_);
...
}),cljs.core.tree_seq(cljs.core.coll_QMARK_,cljs.core.seq,cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic(new cljs.core.Keyword(null,"specs","specs",1426570741),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic(new cljs.core.Keyword(null,"clauses","clauses",1454841241),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__21151_SHARP_){
return cljs.spec.alpha.conform(new cljs.core.Keyword("expound.spec","keys-spec","expound.spec/keys-spec",-1760201532),p1__21151_SHARP_);
}),keys_specs)], 0))], 0))))));
}
});
expound.printer.key__GT_spec = (function expound$printer$key__GT_spec(keys,problems){
var seq__21158_21448 = cljs.core.seq(problems);
var chunk__21159_21449 = null;
var count__21160_21450 = (0);
var i__21161_21451 = (0);
while(true){
if((i__21161_21451 < count__21160_21450)){
var p_21452 = chunk__21159_21449.cljs$core$IIndexed$_nth$arity$2(null, i__21161_21451);
if((!((new cljs.core.Keyword("expound","via","expound/via",-595987777).cljs$core$IFn$_invoke$arity$1(p_21452) == null)))){
} else {
throw (new Error(["Assert failed: ",expound.util.assert_message,"\n","(some? (:expound/via p))"].join('')));
}


var G__21453 = seq__21158_21448;
var G__21454 = chunk__21159_21449;
var G__21455 = count__21160_21450;
var G__21456 = (i__21161_21451 + (1));
seq__21158_21448 = G__21453;
chunk__21159_21449 = G__21454;
count__21160_21450 = G__21455;
i__21161_21451 = G__21456;
continue;
} else {
var temp__5804__auto___21457 = cljs.core.seq(seq__21158_21448);
if(temp__5804__auto___21457){
var seq__21158_21458__$1 = temp__5804__auto___21457;
if(cljs.core.chunked_seq_QMARK_(seq__21158_21458__$1)){
var c__5525__auto___21459 = cljs.core.chunk_first(seq__21158_21458__$1);
var G__21460 = cljs.core.chunk_rest(seq__21158_21458__$1);
var G__21461 = c__5525__auto___21459;
var G__21462 = cljs.core.count(c__5525__auto___21459);
var G__21463 = (0);
seq__21158_21448 = G__21460;
chunk__21159_21449 = G__21461;
count__21160_21450 = G__21462;
i__21161_21451 = G__21463;
continue;
} else {
var p_21464 = cljs.core.first(seq__21158_21458__$1);
if((!((new cljs.core.Keyword("expound","via","expound/via",-595987777).cljs$core$IFn$_invoke$arity$1(p_21464) == null)))){
} else {
throw (new Error(["Assert failed: ",expound.util.assert_message,"\n","(some? (:expound/via p))"].join('')));
}


var G__21465 = cljs.core.next(seq__21158_21458__$1);
var G__21466 = null;
var G__21467 = (0);
var G__21468 = (0);
seq__21158_21448 = G__21465;
chunk__21159_21449 = G__21466;
count__21160_21450 = G__21467;
i__21161_21451 = G__21468;
continue;
}
} else {
}
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(m,k,((cljs.core.qualified_keyword_QMARK_(k))?k:(function (){var or__5002__auto__ = cljs.core.first(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__21153_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(cljs.core.name(k),cljs.core.name(p1__21153_SHARP_));
}),specs));
...
expound.printer.summarize_key_clause = (function expound$printer$summarize_key_clause(p__21178){
var vec__21179 = p__21178;
var branch = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21179,(0),null);
var match = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21179,(1),null);
var G__21182 = branch;
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__21182__$1)].join('')));

}
});
expound.printer.missing_key = (function expound$printer$missing_key(form){
var vec__21193 = cljs.spec.alpha.conform(new cljs.core.Keyword("expound.spec","contains-key-pred","expound.spec/contains-key-pred",-989075236),cljs.core.nth.cljs$core$IFn$_invoke$arity$2(form,(2)));
var branch = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21193,(0),null);
var match = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21193,(1),null);
var G__21196 = branch;
...
var len__5726__auto___21473 = arguments.length;
var i__5727__auto___21474 = (0);
while(true){
if((i__5727__auto___21474 < len__5726__auto___21473)){
args__5732__auto__.push((arguments[i__5727__auto___21474]));

var G__21475 = (i__5727__auto___21474 + (1));
i__5727__auto___21474 = G__21475;
continue;
} else {
}
break;
...
/** @this {Function} */
(expound.printer.format.cljs$lang$applyTo = (function (seq21209){
var G__21210 = cljs.core.first(seq21209);
var seq21209__$1 = cljs.core.next(seq21209);
var self__5711__auto__ = this;
return self__5711__auto__.cljs$core$IFn$_invoke$arity$variadic(G__21210,seq21209__$1);
}));
...
var keys = expound.printer.keywords(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__21225_SHARP_){
return expound.printer.missing_key(new cljs.core.Keyword(null,"pred","pred",1927423397).cljs$core$IFn$_invoke$arity$1(p1__21225_SHARP_));
}),problems));
...
return cljs.core.sort_by.cljs$core$IFn$_invoke$arity$2((function (p1__21226_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(p1__21226_SHARP_,"key");
}),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__21230){
var vec__21232 = p__21230;
...
return clojure.string.join.cljs$core$IFn$_invoke$arity$2(", ",cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__21237_SHARP_){
return expound.ansi.color.cljs$core$IFn$_invoke$arity$variadic(p1__21237_SHARP_,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"correct-key","correct-key",1087492967)], 0));
...
var vec__21272 = clojure.string.split_lines(cljs.core.str.cljs$core$IFn$_invoke$arity$1(s));
var seq__21273 = cljs.core.seq(vec__21272);
var first__21274 = cljs.core.first(seq__21273);
var seq__21273__$1 = cljs.core.next(seq__21273);
var line = first__21274;
var lines = seq__21273__$1;
return clojure.string.join.cljs$core$IFn$_invoke$arity$2("\n",cljs.core.into.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [[cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.str,cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(first_line_indent," "))),cljs.core.str.cljs$core$IFn$_invoke$arity$1(line)].join('')], null),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__21245_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.str,cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(rest_lines_indent," "))),cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__21245_SHARP_)].join('');
}),lines)));
}));
...
while(true){
var vec__21285 = in$;
var seq__21286 = cljs.core.seq(vec__21285);
var first__21287 = cljs.core.first(seq__21286);
var seq__21286__$1 = cljs.core.next(seq__21286);
var k = first__21287;
var rst = seq__21286__$1;
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(displayed_form,new cljs.core.Keyword(null,"key","key",-1516042587).cljs$core$IFn$_invoke$arity$1(k)),(function (){var G__21289 = show_valid_values_QMARK_;
var G__21290 = new cljs.core.Keyword(null,"key","key",-1516042587).cljs$core$IFn$_invoke$arity$1(k);
var G__21291 = rst__$1;
return (expound.printer.summary_form.cljs$core$IFn$_invoke$arity$3 ? expound.printer.summary_form.cljs$core$IFn$_invoke$arity$3(G__21289,G__21290,G__21291) : expound.printer.summary_form.call(null, G__21289,G__21290,G__21291));
})(),new cljs.core.Keyword("expound.problems","irrelevant","expound.problems/irrelevant",2090226124));
} else {
if(((cljs.core.map_QMARK_(form)) && (expound.paths.kvps_QMARK_(k)))){
var G__21485 = show_valid_values_QMARK_;
var G__21486 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(cljs.core.seq(form),new cljs.core.Keyword(null,"idx","idx",1053688473).cljs$core$IFn$_invoke$arity$1(k));
var G__21487 = rst__$1;
show_valid_values_QMARK_ = G__21485;
form = G__21486;
in$ = G__21487;
continue;
} else {
if(cljs.core.associative_QMARK_(form)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(displayed_form,k,(function (){var G__21292 = show_valid_values_QMARK_;
var G__21293 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(form,k);
var G__21294 = rst__$1;
return (expound.printer.summary_form.cljs$core$IFn$_invoke$arity$3 ? expound.printer.summary_form.cljs$core$IFn$_invoke$arity$3(G__21292,G__21293,G__21294) : expound.printer.summary_form.call(null, G__21292,G__21293,G__21294));
})());
} else {
if(((cljs.core.int_QMARK_(k)) && (cljs.core.seq_QMARK_(form)))){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.list,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.vec(displayed_form),k,(function (){var G__21299 = show_valid_values_QMARK_;
var G__21300 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(form,k);
var G__21301 = rst__$1;
return (expound.printer.summary_form.cljs$core$IFn$_invoke$arity$3 ? expound.printer.summary_form.cljs$core$IFn$_invoke$arity$3(G__21299,G__21300,G__21301) : expound.printer.summary_form.call(null, G__21299,G__21300,G__21301));
})()));
} else {
if(((cljs.core.int_QMARK_(k)) && (cljs.core.set_QMARK_(form)))){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentHashSet.EMPTY,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.vec(displayed_form),k,(function (){var G__21305 = show_valid_values_QMARK_;
var G__21306 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(cljs.core.seq(form),k);
var G__21307 = rst__$1;
return (expound.printer.summary_form.cljs$core$IFn$_invoke$arity$3 ? expound.printer.summary_form.cljs$core$IFn$_invoke$arity$3(G__21305,G__21306,G__21307) : expound.printer.summary_form.call(null, G__21305,G__21306,G__21307));
})()));
} else {
if(((cljs.core.int_QMARK_(k)) && (cljs.core.list_QMARK_(form)))){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.List.EMPTY,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.vec(displayed_form),k,(function (){var G__21309 = show_valid_values_QMARK_;
var G__21310 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(cljs.core.seq(form),k);
var G__21311 = rst__$1;
return (expound.printer.summary_form.cljs$core$IFn$_invoke$arity$3 ? expound.printer.summary_form.cljs$core$IFn$_invoke$arity$3(G__21309,G__21310,G__21311) : expound.printer.summary_form.call(null, G__21309,G__21310,G__21311));
})()));
} else {
...
var max_width = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.max,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__21320_SHARP_){
return ((cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__21320_SHARP_)).length);
...
var map__21328 = problem;
var map__21328__$1 = cljs.core.__destructure_map(map__21328);
var form = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21328__$1,new cljs.core.Keyword("expound","form","expound/form",-264680632));
var in$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21328__$1,new cljs.core.Keyword("expound","in","expound/in",-1900412298));
var map__21329 = opts;
var map__21329__$1 = cljs.core.__destructure_map(map__21329);
var show_valid_values_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__21329__$1,new cljs.core.Keyword(null,"show-valid-values?","show-valid-values?",-587258094),false);
...
var s = (function (){var _STAR_print_namespace_maps_STAR__orig_val__21333 = cljs.core._STAR_print_namespace_maps_STAR_;
var _STAR_print_namespace_maps_STAR__temp_val__21334 = false;
(cljs.core._STAR_print_namespace_maps_STAR_ = _STAR_print_namespace_maps_STAR__temp_val__21334);
...
}finally {(cljs.core._STAR_print_namespace_maps_STAR_ = _STAR_print_namespace_maps_STAR__orig_val__21333);
}})();
var vec__21330 = cljs.core.re_find(regex,s);
...
var line = first__21332;
var first__21332__$1 = cljs.core.first(seq__21331__$1);
var seq__21331__$2 = cljs.core.next(seq__21331__$1);
var prefix = first__21332__$1;
var _more = seq__21331__$2;
